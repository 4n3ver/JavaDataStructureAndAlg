...
public class jherndon8JUNIT2 {
    ...
    public void testBubblesort() {
        ...
        System.out.println("Bubble Comparisons: " + comparisons);
    ...
    public void testInsertionsort() {
        Sorting.insertionsort(horde, (new Zombie(null, 0, 0))
                .getNameComparator());
        System.out.println("Insert Comparisons: " + comparisons);
        assertArrayEquals(hordeByName, horde);
    }
    ...
    public void testShellsort() {
        ...
        System.out.println("Shell Comparisons: " + comparisons);
    }
    ...
    public void testQuicksort() {
        ...
        System.out.println("Quick Comparisons: " + comparisons);
    }

    @Test(timeout = TIMEOUT * TIMEOUT)
    public void testBogosort() {
        Sorting.bogosort(horde, (new Zombie(null, 0, 0)).getNameComparator());
        for (int i = 1; i < horde.length; i++) {
            assertTrue(horde[i].getName().compareTo(horde[i - 1].getName())
                    >= 0);
        }
        System.out.println("BOGO! Comparisons: " + comparisons);
    }
    ...
    public void testMergesort() {
        ...
        assertArrayEquals(hordeByName, horde);
        System.out.println("Merge Comparisons: " + comparisons);
    }

    @Test(timeout = TIMEOUT)
    public void tesStableQuicksort() {
        Sorting.stablequicksort(horde, (new Zombie(null, 0, 0)).getNameComparator());
        assertArrayEquals(hordeByName, horde);
        System.out.println("Stable quick Comparisons: " + comparisons);
    }
    ...
    public void testRadixsort() {
        ...
        //@714 - original array should be preserved
        //assertArrayEquals(new int[] {54, 28, 58, 84, 20, 122, 85, 3},
        //unsortedArray);
    }
    ...
    private class Zombie {
        ...
        public Comparator<Zombie> getDaysSinceDeathComparator() {
            return new Comparator<Zombie>() {
                ...
                public int compare(Zombie zombie1, Zombie zombie2) {
                    comparisons++;
                    return zombie1.getDaysSinceDeath() - zombie2.getDaysSinceDeath();
                }
            };
        }
