...
public class lwinyoto3JUNIT {
    ...
    public void kmpTest() {
        ...
        assertTrue("text count was " + text.getCount() + ". Should be <= 44.",
                text.getCount() <= 44);
    }
    ...
    public void boyerMoore() {
        ...
        assertTrue("text count was " + text.getCount() + ". Should be <= 20.",
                text.getCount() <= 20);
        System.out.println("boyerMoore " + text.getCount());
    }
    ...
    public void boyerMoore2() {
        ...
        assertTrue("text count was " + text.getCount() + ". Should be <= 20.",
                text.getCount() <= 20);
        System.out.println("boyerMoore2 " + text.getCount());
    }
    ...
    public void boyerMoore3() {
        ...
        List<Integer> answer = new ArrayList<>();
        assertEquals(answer, stringSearching.boyerMoore(pattern, text));
        assertTrue("text count was " + text.getCount() + ". Should be <= 149.",
                text.getCount() <= 149);
        System.out.println("boyerMoore3 " + text.getCount());
    }
    ...
    public void generateHashTest() {
        ...
        assertEquals(answer, stringSearching.generateHash(pattern,
                pattern.length()));
    }
    ...
    public void generateHashTest2() {
        ...
        assertEquals(-1564278299, stringSearching.generateHash(pattern,
                pattern.length()));
    }
    ...
    public void updateHashTest() {
        ...
        assertEquals(stringSearching.generateHash("abcde", 5),
                stringSearching.updateHash(
                oldHash3, 5, pattern3.charAt(0), pattern3.charAt(5)));
    }
    ...
    public void RabinKarp() {
        ...
        assertTrue("text count was " + text.getCount() + ". Should be <= 68.",
                text.getCount() <= 68);
        System.out.println("RabinKarp " + text.getCount());
    }
    ...
    public void RabinKarp2() {
        ...
        assertTrue("text count was " + text.getCount() + ". Should be <= 68.",
                text.getCount() <= 40);
        System.out.println("RabinKarp2 " + text.getCount());
    }
    ...
    public void RabinKarp3() {
        ...
        answer.add(168);
        assertEquals(answer, stringSearching.rabinKarp(pattern, text));
        assertTrue("text count was " + text.getCount() + ". Should be <= 430.",
                text.getCount() <= 430);
        System.out.println("RabinKarp3 " + text.getCount());
    }

    @Test(timeout = TIMEOUT)
    public void emptyResultTest() {
        SearchableString pattern = new SearchableString(";");
        SearchableString text = new SearchableString("This is my first time "
                + "making a junit test.");
